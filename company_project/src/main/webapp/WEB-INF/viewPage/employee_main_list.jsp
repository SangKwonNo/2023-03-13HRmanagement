					...
					<div class="left-list-content">
						...
						<div class="left-list-employeelist">
							...
							<div class="left-employees">
								...
								<div class="employee">
									<div class="box name" id="name" name="name">김영균</div>
									<div class="box department" id="department" name="department">백엔드</div>
									<div class="box position" id="position" name="position">대리</div>
									<input type="button" value="상세보기">
								</div>
								<div class="employee">
									<div class="box name" id="name" name="name">노상권</div>
